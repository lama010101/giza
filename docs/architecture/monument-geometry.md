...
| ------------------------------- | ------------------------------------------------- | ----------------------------- | ------------------------------ | ------------------ | -------------- | ------- | ------- | ---------- |
| `pyramid-exterior`              | Pyramid Exterior (core masonry)                   | (0, 69.2500, 0)               | (230.3640, 138.5000, 230.3640)  | (0, 0, 0)          | exterior       | #c2b090 | 0.15    |            |
| `casing-north`                  | Casing Stones (north face, lower courses)         | (0, 5, -111.2530)             | (230.3640, 10, 1)               | (0.9048, 0, 0)     | exterior       | #e8e0d0 | 0.7     |            |
| `exterior-detail`               | Exterior Detail (casing, sockets, wall, pyramidion) | (0, 0, 0)                     | (0, 0, 0)                       | (0, 0, 0)          | exterior       | #c2b090 | 0.4     |            |
| `original-entrance`             | Original Entrance                                 | (7.2900, 16.9700, -101.8471)  | (1.0500, 1.1900, 1)             | (0, 0, 0)          | exterior       | #8a7a55 | 1       |            |
| `descending-passage`            | Descending Passage (sloped)                       | (7.2900, -5.9751, -54.5340)   | (1.0500, 1.1900, 105.1600)      | (0.4629, 0, 0)     | passages       | #8a7a55 | 0.4     |            |
| `descending-passage-horizontal` | Descending Passage (horizontal)                   | (7.2900, -29.3900, 0.7828)    | (1.0500, 1.1900, 17.0700)       | (0, 0, 0)          | passages       | #8a7a55 | 0.4     |            |
| `subterranean-chamber`          | Subterranean Chamber                              | (0.6600, -28.2200, 5.1778)    | (14.0700, 3.5600, 8.2800)       | (0, 0, 0)          | subterranean   | #6a5a40 | 0.4     |            |
| `subterranean-pit`              | Central Pit (Subterranean)                        | (0.6600, -32.5150, 5.1778)    | (2.5400, 5.0300, 2.5400)        | (0, 0, 0)          | subterranean   | #5a4a30 | 0.6     |            |
| `ascending-passage`             | Ascending Passage                                 | (7.2900, 15.0151, -62.1797)   | (0.9700, 1.2000, 39.2900)       | (-0.4545, 0, 0)    | passages       | #c2ab7a | 0.4     |            |
| `ascending-plug-1`              | Ascending Passage Plug Block 1                    | (7.2900, 6.6237, -79.3543)    | (0.9700, 1.2000, 1.0600)        | (-0.4545, 0, 0)    | passages       | #5a5a5a | 0.9     |            |
| `ascending-plug-2`              | Ascending Passage Plug Block 2                    | (7.2900, 7.0890, -78.4019)    | (0.9700, 1.2000, 1.0600)        | (-0.4545, 0, 0)    | passages       | #5a5a5a | 0.9     |            |
| `ascending-plug-3`              | Ascending Passage Plug Block 3                    | (7.2900, 7.5543, -77.4495)    | (0.9700, 1.2000, 1.0600)        | (-0.4545, 0, 0)    | passages       | #5a5a5a | 0.9     |            |
| `al-mamun-bypass`               | Al-Mamun Bypass Tunnel                            | (8.4900, 7.3787, -77.8089)    | (0.9700, 1.2000, 3.5000)        | (-0.4545, 0, 0)    | passages       | #b06a4a | 0.6     |            |
| `modern-entrance`               | Modern Entrance (Al-Mamun Tunnel)                 | (8.4900, 8.2079, -92.5885)    | (0.9700, 1.2000, 33.2306)       | (0, 0, 0)          | exterior       | #6b5f45 | 1       |            |
| `grand-gallery`                 | Grand Gallery                                     | (7.2200, 36.2513, -24.7482)   | (2.0900, 8.7400, 47.8500)       | (-0.4587, 0, 0)    | gallery        | #d4c4a0 | 0.35    |            |
| `antechamber`                   | Antechamber                                       | (7.2200, 44.8170, 1.6157)     | (1.6510, 3.7940, 2.9540)        | (0, 0, 0)          | kings-complex  | #a08060 | 0.4     |            |
| `great-step-passage`            | Great Step Landing and Short Passage              | (7.2200, 44.8170, -0.6113)    | (1.6510, 3.7940, 1.5000)        | (0, 0, 0)          | passages       | #a08060 | 0.4     |            |
| `antechamber-kc-passage`        | Antechamber-to-King's-Chamber Passage             | (7.2200, 43.5600, 5.7427)     | (0.9700, 1.2000, 5.3000)        | (0, 0, 0)          | passages       | #8a7050 | 0.4     |            |
| `kings-chamber`                 | King's Chamber                                    | (7.2200, 45.8800, 11.0127)    | (10.4700, 5.8400, 5.2400)       | (0, 0, 0)          | kings-complex  | #8a6050 | 0.4     |            |
| `kings-sarcophagus`             | King's Chamber Sarcophagus                        | (2.4740, 43.4845, 11.0127)    | (0.9780, 1.0490, 2.2760)        | (0, 0, 0)          | kings-complex  | #3a3a3f | 1       |            |
| `relieving-davison`             | Davison's Chamber (Relieving 1)                   | (7.2200, 49.3350, 11.0127)    | (11.6800, 1.0700, 5.2100)       | (0, 0, 0)          | relieving      | #706050 | 0.4     |            |
| `relieving-wellington`          | Wellington's Chamber (Relieving 2)                | (7.2200, 50.4300, 11.0127)    | (11.7300, 1.1200, 5.1800)       | (0, 0, 0)          | relieving      | #706050 | 0.4     |            |
| `relieving-nelson`              | Nelson's Chamber (Relieving 3)                    | (7.2200, 51.7250, 11.0127)    | (11.8100, 1.4700, 5.0800)       | (0, 0, 0)          | relieving      | #706050 | 0.4     |            |
| `relieving-arbuthnot`           | Lady Arbuthnot's Chamber (Relieving 4)            | (7.2200, 53.1350, 11.0127)    | (11.3800, 1.3500, 4.9800)       | (0, 0, 0)          | relieving      | #706050 | 0.4     |            |
| `relieving-campbell`            | Campbell's Chamber (Relieving 5, with cartouches) | (7.2200, 55.1200, 11.0127)    | (11.5300, 2.6200, 6.2500)       | (0, 0, 0)          | relieving      | #807060 | 0.45    |            |
| `queens-chamber`                | Queen's Chamber                                   | (0, 24.3050, 6.3200)          | (5.7500, 6.2300, 5.2300)        | (0, 0, 0)          | queens-complex | #b39b6b | 0.4     |            |
| `queens-niche`                  | Queen's Chamber Niche (East Wall)                 | (2.8750, 23.5350, 6.3200)     | (1.0400, 4.6900, 1.5700)        | (0, 0, 0)          | queens-complex | #a38b5c | 0.6     |            |
| `queens-passage`                | Queen's Chamber Passage                           | (3.6450, 21.7750, -22.2350)   | (1.0500, 1.1700, 52.3897)       | (0, -0.1396, 0)    | passages       | #c2ab7a | 0.4     |            |
| `kc-north-shaft`                | KC North Shaft                                    | (7.2200, 66.8515, -20.0239)   | (0.2050, 0.2050, 67.3306)       | (-2.5726, 0, 0)    | shafts         | #7a6a4a | 0.5     |            |
| `kc-north-shaft-door`           | KC North Shaft Blocking Stone ('Door')            | (7.2200, 60.0817, -9.4382)    | (0.2050, 0.2050, 0.2000)        | (-2.5726, 0, 0)    | shafts         | #9a8a6a | 0.9     |            |
| `kc-south-shaft`                | KC South Shaft                                    | (7.2200, 66.5684, 31.2562)    | (0.2050, 0.2050, 50.0517)       | (-0.7854, 0, 0)    | shafts         | #7a6a4a | 0.5     |            |
| `qc-north-shaft`                | QC North Shaft                                    | (0, 46.2180, -19.6755)        | (0.2100, 0.2100, 60)            | (-2.4609, 0, 0)    | shafts         | #7a6a4a | 0.5     |            |
| `qc-south-shaft`                | QC South Shaft                                    | (0, 46.6236, 31.9835)         | (0.2100, 0.2100, 60)            | (-0.6912, 0, 0)    | shafts         | #7a6a4a | 0.5     |            |
| `qc-north-shaft-door`           | QC North Shaft Blocking Stone ('Door')            | (0, 64.9718, -42.8344)        | (0.2100, 0.2100, 0.2000)        | (-2.4609, 0, 0)    | shafts         | #9a8a6a | 0.9     |            |
| `qc-south-shaft-door`           | QC South Shaft Blocking Stone ('Door')            | (0, 65.6189, 54.9448)         | (0.2100, 0.2100, 0.2000)        | (-0.6912, 0, 0)    | shafts         | #9a8a6a | 0.9     |            |
| `well-shaft`                    | Well Shaft                                        | (6.1750, -2.3265, -25.6841)   | (0.7800, 0.7800, 65.9211)       | (0.9838, 0, 0)     | shafts         | #6a5a40 | 0.5     |            |
| `grotto`                        | Grotto                                            | (6.1750, -1.5425, -26.0089)   | (2, 2, 2)                       | (0, 0, 0)          | passages       | #7a6a4a | 0.5     |            |
...
| `exterior-detail`               | Exterior Detail (casing, sockets, wall, pyramidion) | (0, 0, 0)                     | (0, 0, 0)                       | (0, 0, 0)          | exterior       | #c2b090 | 0.4     | inferred   |
...
| `ascending-plug-1`              | Ascending Passage Plug Block 1                    | (7.2900, 6.6237, -79.3543)    | (0.9700, 1.2000, 1.0600)        | (-0.4545, 0, 0)    | passages       | #5a5a5a | 0.9     | inferred   |
| `ascending-plug-2`              | Ascending Passage Plug Block 2                    | (7.2900, 7.0890, -78.4019)    | (0.9700, 1.2000, 1.0600)        | (-0.4545, 0, 0)    | passages       | #5a5a5a | 0.9     | inferred   |
| `ascending-plug-3`              | Ascending Passage Plug Block 3                    | (7.2900, 7.5543, -77.4495)    | (0.9700, 1.2000, 1.0600)        | (-0.4545, 0, 0)    | passages       | #5a5a5a | 0.9     | inferred   |
| `al-mamun-bypass`               | Al-Mamun Bypass Tunnel                            | (8.4900, 7.3787, -77.8089)    | (0.9700, 1.2000, 3.5000)        | (-0.4545, 0, 0)    | passages       | #b06a4a | 0.6     | inferred   |
| `modern-entrance`               | Modern Entrance (Al-Mamun Tunnel)                 | (8.4900, 8.2079, -92.5885)    | (0.9700, 1.2000, 33.2306)       | (0, 0, 0)          | exterior       | #6b5f45 | 1       | measured   |
...
| `great-step-passage`            | Great Step Landing and Short Passage              | (7.2200, 44.8170, -0.6113)    | (1.6510, 3.7940, 1.5000)        | (0, 0, 0)          | passages       | #a08060 | 0.4     | inferred   |
| `antechamber-kc-passage`        | Antechamber-to-King's-Chamber Passage             | (7.2200, 43.5600, 5.7427)     | (0.9700, 1.2000, 5.3000)        | (0, 0, 0)          | passages       | #8a7050 | 0.4     | inferred   |
| `kings-chamber`                 | King's Chamber                                    | (7.2200, 45.8800, 11.0127)    | (10.4700, 5.8400, 5.2400)       | (0, 0, 0)          | kings-complex  | #8a6050 | 0.4     | measured   |
| `kings-sarcophagus`             | King's Chamber Sarcophagus                        | (2.4740, 43.4845, 11.0127)    | (0.9780, 1.0490, 2.2760)        | (0, 0, 0)          | kings-complex  | #3a3a3f | 1       | measured   |
| `relieving-davison`             | Davison's Chamber (Relieving 1)                   | (7.2200, 49.3350, 11.0127)    | (11.6800, 1.0700, 5.2100)       | (0, 0, 0)          | relieving      | #706050 | 0.4     | calculated |
| `relieving-wellington`          | Wellington's Chamber (Relieving 2)                | (7.2200, 50.4300, 11.0127)    | (11.7300, 1.1200, 5.1800)       | (0, 0, 0)          | relieving      | #706050 | 0.4     | calculated |
| `relieving-nelson`              | Nelson's Chamber (Relieving 3)                    | (7.2200, 51.7250, 11.0127)    | (11.8100, 1.4700, 5.0800)       | (0, 0, 0)          | relieving      | #706050 | 0.4     | calculated |
| `relieving-arbuthnot`           | Lady Arbuthnot's Chamber (Relieving 4)            | (7.2200, 53.1350, 11.0127)    | (11.3800, 1.3500, 4.9800)       | (0, 0, 0)          | relieving      | #706050 | 0.4     | calculated |
| `relieving-campbell`            | Campbell's Chamber (Relieving 5, with cartouches) | (7.2200, 55.1200, 11.0127)    | (11.5300, 2.6200, 6.2500)       | (0, 0, 0)          | relieving      | #807060 | 0.45    | calculated |
| `queens-chamber`                | Queen's Chamber                                   | (0, 24.3050, 6.3200)          | (5.7500, 6.2300, 5.2300)        | (0, 0, 0)          | queens-complex | #b39b6b | 0.4     | measured   |
| `queens-niche`                  | Queen's Chamber Niche (East Wall)                 | (2.8750, 23.5350, 6.3200)     | (1.0400, 4.6900, 1.5700)        | (0, 0, 0)          | queens-complex | #a38b5c | 0.6     | measured   |
| `queens-passage`                | Queen's Chamber Passage                           | (3.6450, 21.7750, -22.2350)   | (1.0500, 1.1700, 52.3897)       | (0, -0.1396, 0)    | passages       | #c2ab7a | 0.4     | calculated |
| `kc-north-shaft`                | KC North Shaft                                    | (7.2200, 66.8515, -20.0239)   | (0.2050, 0.2050, 67.3306)       | (-2.5726, 0, 0)    | shafts         | #7a6a4a | 0.5     | calculated |
| `kc-north-shaft-door`           | KC North Shaft Blocking Stone ('Door')            | (7.2200, 60.0817, -9.4382)    | (0.2050, 0.2050, 0.2000)        | (-2.5726, 0, 0)    | shafts         | #9a8a6a | 0.9     | inferred   |
| `kc-south-shaft`                | KC South Shaft                                    | (7.2200, 66.5684, 31.2562)    | (0.2050, 0.2050, 50.0517)       | (-0.7854, 0, 0)    | shafts         | #7a6a4a | 0.5     | calculated |
| `qc-north-shaft`                | QC North Shaft                                    | (0, 46.2180, -19.6755)        | (0.2100, 0.2100, 60)            | (-2.4609, 0, 0)    | shafts         | #7a6a4a | 0.5     | calculated |
| `qc-south-shaft`                | QC South Shaft                                    | (0, 46.6236, 31.9835)         | (0.2100, 0.2100, 60)            | (-0.6912, 0, 0)    | shafts         | #7a6a4a | 0.5     | calculated |
| `qc-north-shaft-door`           | QC North Shaft Blocking Stone ('Door')            | (0, 64.9718, -42.8344)        | (0.2100, 0.2100, 0.2000)        | (-2.4609, 0, 0)    | shafts         | #9a8a6a | 0.9     | inferred   |
| `qc-south-shaft-door`           | QC South Shaft Blocking Stone ('Door')            | (0, 65.6189, 54.9448)         | (0.2100, 0.2100, 0.2000)        | (-0.6912, 0, 0)    | shafts         | #9a8a6a | 0.9     | inferred   |
| `well-shaft`                    | Well Shaft                                        | (6.1750, -2.3265, -25.6841)   | (0.7800, 0.7800, 65.9211)       | (0.9838, 0, 0)     | shafts         | #6a5a40 | 0.5     | inferred   |
| `grotto`                        | Grotto                                            | (6.1750, -1.5425, -26.0089)   | (2, 2, 2)                       | (0, 0, 0)          | passages       | #7a6a4a | 0.5     | inferred   |
